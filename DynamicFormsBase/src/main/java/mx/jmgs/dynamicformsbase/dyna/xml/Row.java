 ...
 *           &lt;element name="inputNumber" type="{http://www.dynamicforms.mx/dynaform-1.0}inputNumber"/>
 *           &lt;element name="password" type="{http://www.dynamicforms.mx/dynaform-1.0}password"/>
...
public class Row {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "inputNumber", type = InputNumber.class),
